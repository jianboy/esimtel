...
typedef PaymentFailureCallback = void Function(CFErrorResponse error, String orderId);
class CashfreeService {
  ...
  void openPayment({
    ...
    if (data == null || data.gatewayOrderId == null || data.payment_session_id == null) {
    ...
    _cfPaymentGateway.setCallback(
      ...
      (error, failedOrderId) {
        log("❌ Payment failed for orderId: $failedOrderId "
            "Code: ${error.getCode()} "
